...
public class Client  implements MessageTypes{
    ...
    public Client(String username){
             ...
             while(!messageResult.equals("SHUTDOWN"))
             {
    ...
    public void sendClientInfo()
    {
        try
        {
            ...
            System.out.println(this.socket.getLocalAddress().toString());
            this.myInfo = new Message(username, this.myNode);
            this.msg.setNode(this.myNode);
            objectWriter.writeObject(myInfo);
            System.out.println("My information has been output to the server");
    ...
    public void generateLocalServer()
    {
        try
        {
            ...
            System.out.println("LocalServer Generated: " + localSocketServer.getLocalSocketAddress().toString());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void main(String[] args)  {
        ...
        propertiesFile = "client/Server.properties";
        //
